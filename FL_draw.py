...
if __name__== "__main__":
    ...
    Eh_coordinates=helper.eye_detection(image,contours_mask,masked_image,dim_to_calculate="Eh",confusion=True,
                                        show_image=False)
    Hd_coordinates=helper.eye_detection(image,contours_mask,masked_image,dim_to_calculate="Hd",confusion=True)
    Ed_coordinates=helper.eye_detection(image,contours_mask,masked_image,dim_to_calculate="Ed",confusion=True,
